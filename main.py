...
def Search(dept, arrv, date, cur, ali):
    ...
    driver = webdriver.Chrome(executable_path='/Users/hongleizhou/Projects/fly_home/chromedriver', chrome_options=chrome_options)
...
if __name__ == '__main__':
    ...
    if intv.days > 90:
        ...
        df_record.to_csv('flight_search_jk.csv', encoding="utf-8")
